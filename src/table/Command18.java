...
public class Command18 implements Command
{
  ...
  public Command18(String tableName, long[] elementCode, int[] subtableIndex, long subelementCode, int column, int amount, Object aValue, String currentUser, DateRepresentation date, long versionAfterExecuting)
  {
    this.errorMessage = "";
  ...
  public Command read(MyObjectInputStream in, boolean local) throws IOException
  {
    ...
    {
      if(local)
        return new Command18(tn, ec, si, sc, c, a, v, in.readUTF(), (DateRepresentation) in.readObject(),in.readLong());
      return new Command18(tn, ec, si, sc, c, a, v, in.readUTF(), (DateRepresentation) in.readObject(),Data.version + 1);
    } catch (ClassNotFoundException e)
    {
      e.printStackTrace();
    }
  ...
  public boolean execute(IncomingClientThread clientThread, DB db, String language)
  {
    try
    {
      ...
      t.splitTableElement(this.subelementCode, this.column, this.amount, this.aValue, language, this.currentUser, this.date);
