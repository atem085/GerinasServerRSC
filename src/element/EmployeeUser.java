 ...
 * @version 1.0
 */
public class EmployeeUser extends StaticUser
{
  /**
  ...
  public EmployeeUser(String name, String password, String realName)
  {
    super(name, password);
  ...
  public int compareTo(TableElement element, int column, boolean ascending, int howToRead)
  {
    if(ascending)
      switch(column)
      {
        ...
        case 0:
          return new String(super.name).compareTo((String)element.getValue(column, howToRead));
        case 1:
          return new String(super.password).compareTo((String)element.getValue(column, howToRead));
        case 2:
          return(new Boolean(super.isLoggedIn)).toString().compareTo(((Boolean)element.getValue(column, howToRead)).toString());
        case 3:
          return(new Boolean(super.needsUpdate)).toString().compareTo(((Boolean)element.getValue(column, howToRead)).toString());
        case 4:
          return new String(this.realName).compareTo((String)element.getValue(column, howToRead));
        default:
          return(new Long(this.code)).compareTo((Long)element.getValue(column, howToRead));
      ...
      switch(column)
      {
        ...
        case 0:
          return((String)element.getValue(column, howToRead)).compareTo(new String(super.name));
        case 1:
          return((String)element.getValue(column, howToRead)).compareTo(new String(super.password));
        case 2:
          return(((Boolean)element.getValue(column, howToRead))).toString().compareTo((new Boolean(super.isLoggedIn)).toString());
        case 3:
          return(((Boolean)element.getValue(column, howToRead))).toString().compareTo((new Boolean(super.needsUpdate)).toString());
        case 4:
          return((String)element.getValue(column, howToRead)).compareTo(new String(this.realName));
        default:
          return((Long)element.getValue(column, howToRead)).compareTo(new Long(this.code));
      }
  }
  ...
  public boolean equals(Object obj)
  {
    try
    {
      return this.code == ((EmployeeUser)obj).code;
    }
  ...
  {
    return new EmployeeUser(new String((char[])super.name.clone()), new String((char[])super.password.clone()),
                            new String((char[])this.realName.clone()));
  }

  public String toString(int howToRead)
  {
    String s = new String(super.name) + "\t" + new String(super.password) + "\t" +
        super.isLoggedIn + "\t" + super.needsUpdate + "\t" + this.realName + "\t" + super.getCommandsSize();
    return s;
  }
  ...
  public boolean isCellEditable(int column, int howToRead)
  {
    if(column < 0)
      return false;
    if((column == 0 || column == 2) && new String(super.name).equals("admin"))
      return false;
