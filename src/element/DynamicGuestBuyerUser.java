 ...
 * @version 1.0
 */
public class DynamicGuestBuyerUser extends User
{
  /**
  ...
  public DynamicGuestBuyerUser(String name, String password, String realName, long codeBuyer, int howToRead)
  {
    super(name, password);
    ...
    if(howToRead == 1)
      parentTable = Data.db.getTable(Consts.tbDynamicGuestBuyerUsers);
    else
      parentTable = Data.db.getTable(Consts.tbWebGuestBuyerUsers);
    this.howToRead = howToRead;
    this.settings = new Table("settings_of_dynamic_guest_buyer_user_" + new String(this.name) + "_" + new String(this.password),
  ...
  public boolean equals(Object obj)
  {
    try
    {
      return this.code == ((DynamicGuestBuyerUser)obj).code;
    }
  ...
  {
    return new DynamicGuestBuyerUser(new String((char[])this.name.clone()), new String((char[])this.password.clone()),
                                     new String((char[])this.realName.clone()), this.buyer.getCode().longValue(), this.howToRead);
  }
  ...
  public String toString(int howToRead)
  {
    String s = new String(this.name) + "\t" + new String(this.password) + "\t" +
        ...
        + "\t" + this.buyer.getCode().longValue() + "\t" + this.buyer.getValue(1, 1);
    return s;
  }
