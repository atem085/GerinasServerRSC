 ...
 * @version 1.0
 */
public class DynamicEmployeeUserExample implements TableElementExample
{
  /**
  ...
  public DynamicEmployeeUserExample(String name, String password, String realName)
  {
  ...
  {
    return Consts.clDynamicEmployeeUser(language);
  }
  ...
  public TableElement newInstance(Object[] parameters, int howToRead, TableElement parentElement)
  {
    try
    {
      return new DynamicEmployeeUser( (String)parameters[0], (String)parameters[1], (String)parameters[2], howToRead);
    }
    catch(Exception e)
    {
      //e.printStackTrace();
  ...
  public TableElement read(MyObjectInputStream in, int howToRead, Table parentTable, TableElement parentElement)
  {
    try
    {
      DynamicEmployeeUser eu = new DynamicEmployeeUser(in.readUTF(), in.readUTF(), in.readUTF(), howToRead);
  ...
  {
    return Consts.gtEmployeeUser(language, howToRead);
  }
