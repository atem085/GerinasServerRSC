 ...
 * @version 1.0
 */
public class GuestUser extends StaticUser
{
  /**
  ...
  public GuestUser()
  {
    super();
    this.code = 0;
    this.settings = new Table("settings_of_guest_user_" + new String(this.name) + "_" + new String(this.password),
                              new TableAuthorizationExample("", true), 1, 0, this, null);
  }

  public GuestUser(String name, String password, String realName, long codeCustomer)
  {
    super(name, password);
    ...
    this.settings = new Table("settings_of_guest_user_" + new String(this.name) + "_" + new String(this.password),
                              new TableAuthorizationExample("", true), 1, 0, this, Data.db.getTable(Consts.tbGuestUsers));
  }
  ...
  public boolean equals(Object obj)
  {
    try
    {
      return this.code == ((GuestUser)obj).code;
    }
  ...
  {
    return new GuestUser(new String((char[])super.name.clone()), new String((char[])super.password.clone()),
                         new String((char[])this.realName.clone()), this.customer.getCode().longValue());
  }
  ...
  public String toString(int howToRead)
  {
    String s = new String(super.name) + "\t" + new String(super.password) + "\t" +
        ...
        + "\t" + this.customer.getCode().longValue() + "\t" + this.customer.getValue(1, 1) + "\t" + super.getCommandsSize();
    return s;
  }
